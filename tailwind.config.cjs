  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        tech: "linear-gradient(165deg, rgba(20,20,20,0.8) 100%, rgba(109,109,116,0.8) 100%), url('/src/assets/personal/clapperboard-popcorn-film-stripe-cinema-tickets-wooden-desk.jpg')",
      },
      fontFamily: {
        arenq: ['Arenq'],
        beckman: ['Beckman'],
